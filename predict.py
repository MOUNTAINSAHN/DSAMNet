...
parser.add_argument('--model_dir', default='./epochs/CDD/netCD_epoch_50.pth', type=str)
parser.add_argument('--time1_dir', default='./testimage/time1/', type=str)
parser.add_argument('--time2_dir', default='./testimage/time2/', type=str)
parser.add_argument('--label_dir', default='./testimage/label/', type=str)
...
if __name__ == '__main__':
    ...
    for image1, image2, label, image_name in test_bar:
        ...
        cv2.imwrite(opt.save_dir + image_name[0], result_test * 255)
